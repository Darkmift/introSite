<template>
	<div class="specialties">
		...
		<div class="card-container flex j-center">
			...
			<div class="card">
				<span class="fa-stack fa-4x">
					<svg
						...
						viewBox="0 0 448 512"
						class="svg-inline--fa fa-node-js fa-w-14 fa-2x"
					>
						<path
							fill="currentColor"
			...
			<!-- card2 php-->
			<div class="card">
				<span style="margin-right: 50px" class="fa-stack fa-4x">
					<svg
						aria-hidden="true"
						focusable="false"
						data-prefix="fab"
						...
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 640 512"
						class="svg-inline--fa fa-php fa-w-20 fa-2x"
					>
						<path
							fill="currentColor"
			...
			<div class="card">
				<span class="fa-stack fa-4x">
					<svg
						...
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 448 512"
						class="svg-inline--fa fa-angular fa-w-14 fa-2x"
					>
						<path
							fill="currentColor"
